...
RM2018_OAC_input <- read.csv("2018_Household_Raw_Variables.csv", stringsAsFactors = T)
...
if(RQOUTPUT=="YES")
{
  ...
  write.table(RM2018_OAC_Input_PCT_RATIO, paste("Pre-Cluster Data/01_RM2018_HouseholdPercentages.csv", sep = ""), sep = ",", row.names= FALSE, col.names = TRUE, qmethod = "double")
}
...
if(RQTRANSFORMATION =="IHS")
{
  ...
  {
    dir.create("Pre-Cluster Data", showWarnings = FALSE)
    write.table(RM2018_OAC_Input_PCT_RATIO_IHS, paste("Pre-Cluster Data/02_RM2018_Household_Percentages_IHS_Transformed.csv", sep = ""), sep = ",", row.names= FALSE, col.names = TRUE, qmethod = "double")
  }
...
if (RQTRANSFORMATION == "BOXCOX") {RM2018_OAC_Input_PCT_RATIO_TRANSFORM <- RM2018_OAC_PCT_RATIO_BC}
...
{
  dir.create("Pre-Cluster Data", showWarnings = FALSE)
  write.table(RM2018_OAC_Converted_Transformed_Range, paste("Pre-Cluster Data/03_RM2018_Household_Percentages_Transformed_Range.csv", sep = ""), sep = ",", row.names= FALSE, col.names = TRUE, qmethod = "double")
}
...
if(RQOUTPUT=="YES")
{
  save.image("RM2018_Household_Converted_Transformed_Range_Raw_Cluster_Data.RData")
}
...
write.table(RM2018_OAC_Converted_Transformed_Range_CSV_Output, paste("Cluster Data/RM2018_Household_Converted_Transformed_Range_", i, "_KMeans_Runs.csv", sep = ""), sep = ",", row.names= FALSE, col.names = TRUE, qmethod = "double")

write.table(RM2018_OAC_Converted_Transformed_Range_Cluster_Metadata, paste("Cluster Data/RM2018_Household_Converted_Transformed_Range_Cluster_Metadata_", i, "_Runs.csv", sep = ""), sep = ",", row.names=FALSE, col.names = TRUE, qmethod = "double")

ClusterEnd <- Sys.time()

save.image("RM2018_Household_Converted_Transformed_Range_Clustered.RData")
