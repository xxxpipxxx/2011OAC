...
rm2018person <- rm2018person %>% 
  ...
  filter(POSTCODE != "") %>% 
  mutate(POSTCODE = as.factor(POSTCODE))
table(rm2018person$POSTCODE)

## cant use census vars at postcode level
...
Total_Population <- rm2018person %>% 
  ...
  complete(POSTCODE, fill = list(Total_Population = 0))

Total_Households <- rm2018HH %>% 
  group_by(POSTCODE) %>% 
  summarise(Total_Households = n()) %>% 
  complete(POSTCODE, fill = list(count = 0)) %>%
...
Total_Population_16_and_over <- rm2018person %>% 
  ...
  complete(POSTCODE, fill = list(Total_Population_16_and_over = 0)) %>% 
...
Total_Population_16_to_74 <- rm2018person %>% 
  ...
  complete(POSTCODE, fill = list(Total_Population_16_to_74 = 0)) %>% 
...
Total_Population_3_and_over <- rm2018person %>% 
  ...
  complete(POSTCODE, fill = list(Total_Population_3_and_over = 0)) %>% 
...
Total_Population_school_census  <- rm2018person %>% 
  ...
  complete(POSTCODE, fill = list(Total_Population_school_census = 0)) %>% 
...
RM2018_01 <- rm2018person %>% # Persons aged 0 to 4
  ...
  complete(POSTCODE, fill = list(RM2018_01 = 0)) %>% 
  select(RM2018_01)
...
RM2018_03 <- rm2018person %>% # Persons aged 25 to 44
  ...
  complete(POSTCODE, fill = list(RM2018_03 = 0)) %>% 
  select(RM2018_03)
...
RM2018_04 <- rm2018person %>% # Persons aged 45 to 64
  ...
  complete(POSTCODE, fill = list(RM2018_04 = 0)) %>% 
  select(RM2018_04)
...
RM2018_05 <- rm2018person %>% # Persons aged 65 to 89
  ...
  complete(POSTCODE, fill = list(RM2018_05 = 0)) %>% 
  select(RM2018_05)
...
RM2018_06 <- rm2018person %>% # Persons aged 90 and over
  ...
  complete(POSTCODE, fill = list(RM2018_06 = 0)) %>% 
  select(RM2018_06)
...
RM2018_08 <- rm2018person %>% # 
  ...
  complete(POSTCODE, fill = list(RM2018_08 = 0)) %>% 
  select(RM2018_08)
...
RM2018_09 <- rm2018person %>% # 
  ...
  complete(POSTCODE, fill = list(RM2018_09 = 0)) %>% 
  select(RM2018_09)
...
RM2018_10 <- rm2018person %>% # 
  ...
  complete(POSTCODE, fill = list(RM2018_10 = 0)) %>% 
  select(RM2018_10)
...
RM2018_11 <- rm2018person %>% # 
  ...
  complete(POSTCODE, fill = list(RM2018_11 = 0)) %>% 
  select(RM2018_11)
...
RM2018_12 <- rm2018person %>% # 
  ...
  complete(POSTCODE, fill = list(RM2018_12 = 0)) %>% 
  select(RM2018_12)
...
RM2018_13 <- rm2018person %>% # 
  ...
  complete(POSTCODE, fill = list(RM2018_13 = 0)) %>% 
  select(RM2018_13)
...
RM2018_14 <- rm2018person %>% # 
  ...
  complete(POSTCODE, fill = list(RM2018_14 = 0)) %>% 
  select(RM2018_14)
...
RM2018_15 <- rm2018person %>% # 
  ...
  complete(POSTCODE, fill = list(RM2018_15 = 0)) %>% 
  select(RM2018_15)
...
RM2018_17 <- rm2018person %>%  #  Language other than English spoken at home based on annual school census
  ...
  complete(POSTCODE, fill = list(RM2018_17 = 0)) %>% 
  select(RM2018_17)
...
RM2018_18 <- rm2018HH %>% # Households with no children under 16
  ...
  complete(POSTCODE, fill = list(RM2018_18 = 0)) %>% 
  select(RM2018_18)
...
RM2018_21 <- rm2018HH %>% # 
  ...
  complete(POSTCODE, fill = list(RM2018_21 = 0)) %>% 
  select(RM2018_21)
...
RM2018_22 <- rm2018HH %>% # 
  ...
  complete(POSTCODE, fill = list(RM2018_22 = 0)) %>% 
  select(RM2018_22)
...
RM2018_23 <- rm2018HH %>% # 
  ...
  complete(POSTCODE, fill = list(RM2018_23 = 0)) %>% 
  select(RM2018_23)
...
RM2018_24 <- rm2018HH %>% # 
  ...
  complete(POSTCODE, fill = list(RM2018_24 = 0)) %>% 
  select(RM2018_24)
...
RM2018_25 <- rm2018HH %>% # 
  ...
  complete(POSTCODE, fill = list(RM2018_25 = 0)) %>% 
  select(RM2018_25)
...
RM2018_26 <- rm2018HH %>% # 
  ...
  complete(POSTCODE, fill = list(RM2018_26 = 0)) %>% 
  select(RM2018_26)
...
RM2018_27 <- rm2018HH %>% # 
  ...
  complete(POSTCODE, fill = list(RM2018_27 = 0)) %>% 
  select(RM2018_27)
...
RM2018_28 <- rm2018HH %>% # 
  ...
  complete(POSTCODE, fill = list(RM2018_28 = 0)) %>% 
  select(RM2018_28)
...
RM2018_29 <- rm2018HH %>% # 
  ...
  complete(POSTCODE, fill = list(RM2018_29 = 0)) %>% 
  select(RM2018_29)
...
RM2018_30 <- rm2018HH %>% # 
  ...
  complete(POSTCODE, fill = list(RM2018_30 = 0)) %>% 
  select(RM2018_30)
...
RM2018_31 <- rm2018HH %>% # 
  ...
  complete(POSTCODE, fill = list(RM2018_31 = 0)) %>% 
  select(RM2018_31)
...
RM2018_40 <- rm2018HH %>% # Households Receiving Housing Benefit
  ...
  complete(POSTCODE, fill = list(RM2018_40 = 0)) %>% 
  select(RM2018_40)
...
RM2018_41 <- rm2018HH %>% # Households Receiving Ctax Relief Benefit
  ...
  complete(POSTCODE, fill = list(RM2018_41 = 0)) %>% 
  select(RM2018_41)
...
RM2018_42 <- rm2018HH %>% # Households Receiving Housing Benefit and Ctax relief
  ...
  complete(POSTCODE, fill = list(RM2018_42 = 0)) %>% 
  select(RM2018_42)
...
RM2018_43 <- rm2018person %>% # persons on school census recieving fsm
  ...
  complete(POSTCODE, fill = list(RM2018_43 = 0)) %>% 
  select(RM2018_43)
...
RM2018_Postcode_input<- RM2018_Postcode_input %>% 
  filter(Total_Population > 19)
...
fwrite(RM2018_Postcode_input, "2018_Postcode_Raw_Variables.csv")
