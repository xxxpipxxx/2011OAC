...
RM2018_03 <- rm2018person %>% # Persons aged 25 to 44
  ...
  complete(ID_Master, fill = list(RM2018_03 = 0)) %>% 
  select(RM2018_03)
...
RM2018_04 <- rm2018person %>% # Persons aged 45 to 64
  ...
  complete(ID_Master, fill = list(RM2018_04 = 0)) %>% 
  select(RM2018_04)
...
RM2018_05 <- rm2018person %>% # Persons aged 65 to 89
  ...
  complete(ID_Master, fill = list(RM2018_05 = 0)) %>% 
  select(RM2018_05)
...
RM2018_06 <- rm2018person %>% # Persons aged 90 and over
  ...
  complete(ID_Master, fill = list(RM2018_06 = 0)) %>% 
  select(RM2018_06)
...
RM2018_08 <- rm2018person %>% # 
  ...
  complete(ID_Master, fill = list(RM2018_08 = 0)) %>% 
  select(RM2018_08)
...
RM2018_09 <- rm2018person %>% # 
  ...
  complete(ID_Master, fill = list(RM2018_09 = 0)) %>% 
  select(RM2018_09)
...
RM2018_10 <- rm2018person %>% # 
  ...
  complete(ID_Master, fill = list(RM2018_10 = 0)) %>% 
  select(RM2018_10)
...
RM2018_11 <- rm2018person %>% # 
  ...
  complete(ID_Master, fill = list(RM2018_11 = 0)) %>% 
  select(RM2018_11)
...
RM2018_12 <- rm2018person %>% # 
  ...
  complete(ID_Master, fill = list(RM2018_12 = 0)) %>% 
  select(RM2018_12)
...
RM2018_13 <- rm2018person %>% # 
  ...
  complete(ID_Master, fill = list(RM2018_13 = 0)) %>% 
  select(RM2018_13)
...
RM2018_14 <- rm2018person %>% # 
  ...
  complete(ID_Master, fill = list(RM2018_14 = 0)) %>% 
  select(RM2018_14)
...
RM2018_15 <- rm2018person %>% # 
  ...
  complete(ID_Master, fill = list(RM2018_15 = 0)) %>% 
  select(RM2018_15)
...
RM2018_17 <- rm2018person %>%  #  Language other than English spoken at home based on annual school census
  ...
  complete(ID_Master, fill = list(RM2018_17 = 0)) %>% 
  select(RM2018_17)

RM2018_18 <- rm2018person %>% # Households with no children under 16
  filter(numunder16 == 0  ) %>%
  group_by(ID_Master) %>%
  summarise(RM2018_18 = n())  %>% 
  complete(ID_Master, fill = list(RM2018_18 = 0)) %>% 
  select(RM2018_18)

RM2018_21 <- rm2018person %>% # 
  filter(householdtype == "cohabiting adult households no under 16's"  ) %>%
  group_by(ID_Master) %>%
  summarise(RM2018_21 = n())  %>% 
  complete(ID_Master, fill = list(RM2018_21 = 0)) %>% 
  select(RM2018_21)

RM2018_22 <- rm2018person %>% # 
  filter(householdtype == "Family households with dependent children"  ) %>%
  group_by(ID_Master) %>%
  summarise(RM2018_22 = n())  %>% 
  complete(ID_Master, fill = list(RM2018_22 = 0)) %>% 
  select(RM2018_22)

RM2018_23 <- rm2018person %>% # 
  filter(householdtype == "older cohabiting households"  ) %>%
  group_by(ID_Master) %>%
  summarise(RM2018_23 = n())  %>% 
  complete(ID_Master, fill = list(RM2018_23 = 0)) %>% 
  select(RM2018_23)
...
RM2018_31 <- rm2018person %>% # 
  filter(estimated_tenure2018 == "Reside"  ) %>%
  group_by(ID_Master) %>%
  summarise(RM2018_31 = n())  %>% 
  complete(ID_Master, fill = list(RM2018_31 = 0)) %>% 
  select(RM2018_31)

RM2018_40 <- rm2018person %>% # Households Receiving Housing Benefit
  filter(BenRecieved == "HB"  ) %>%
  group_by(ID_Master) %>%
  summarise(RM2018_40 = n())  %>% 
  complete(ID_Master, fill = list(RM2018_40 = 0)) %>% 
  select(RM2018_40)
...
RM2018_42 <- rm2018person %>% # Households Receiving Housing Benefit and Ctax relief
  filter(BenRecieved == "BOTH"  ) %>%
  group_by(ID_Master) %>%
  summarise(RM2018_42 = n())  %>% 
  complete(ID_Master, fill = list(RM2018_42 = 0)) %>% 
  select(RM2018_42)
