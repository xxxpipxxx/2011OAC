...
if(RQOUTPUT=="YES")
{
  ...
  write.table(RM2018_OAC_Input_PCT_RATIO, paste("Clustergroups/01_RM2018_Individual_clusters_Percentages.csv", sep = ""), sep = ",", row.names= FALSE, col.names = TRUE, qmethod = "double")
}
